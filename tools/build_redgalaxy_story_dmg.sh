...
WEB_DIR="$PROJECT_DIR/artifacts/redgalaxy-story-web"
DIST_DIR="$PROJECT_DIR/dist"
BUILD_DIR="$DIST_DIR/build-story"
APP_DIR="$DIST_DIR/RedGalaxy Bastion.app"
DMG_ROOT="$DIST_DIR/dmg-story-root"
DMG_RW="$BUILD_DIR/RedGalaxy-Bastion.rw.dmg"
DMG_PATH="$DIST_DIR/RedGalaxy-Bastion.dmg"
...
<dict>
  ...
  <string>RedGalaxy Bastion</string>
  <key>CFBundleExecutable</key>
  <string>$APP_EXECUTABLE</string>
  <key>CFBundleIconFile</key>
  <string>AppIcon</string>
  <key>CFBundleIdentifier</key>
  <string>local.redgalaxy.bastion</string>
...
on run argv
  ...
  tell application "Finder"
    tell disk volumeName
      ...
      set position of item "RedGalaxy Bastion.app" of container window to {170, 210}
